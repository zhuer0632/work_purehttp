...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/statics/css/zh-cn-system.css">
    <link type="text/css" rel="stylesheet" href="/statics/css/table_form.css">
    <link type="text/css" rel="stylesheet" href="/statics/css/dialog.css">
    <script src="http://phpcms.com/statics/js/dialog.js" type="text/javascript" language="javascript"></script>
    <link media="screen" title="styles1" href="/statics/css/style/zh-cn-styles1.css" type="text/css" rel="stylesheet">
    <link media="screen" title="styles2" href="/statics/css/style/zh-cn-styles2.css" type="text/css" rel="alternate stylesheet">
    ...
    <script src="/statics/js/styleswitch.js" type="text/javascript" language="javascript"></script>
...
<div class="pad-10">
    <div class="content-menu ib-a blue line-x">
        <a onclick="javascript:initconn();" href="javascript:;" class="add fb"><em>初始化连接</em></a>&#12288;
        <a onclick="javascript:openwinx('/test/test/curd/show_add','')" href="javascript:;" class="add fb"><em>新建表</em></a>&#12288;
